      ...
      >
        ...
        >
          ...
          <div
            ...
            data-align={align}
            className={cn(
              "preview relative flex w-full justify-center p-4 md:p-6 lg:p-10 isolate data-[align=center]:items-center data-[align=end]:items-end data-[align=start]:items-start",
              heightClass
            )}
          >
            {component}
