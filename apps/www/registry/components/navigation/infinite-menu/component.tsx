...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items, scale = 1.0 }) => {
  ...
  useEffect(() => {
    ...
    const handleActiveItem = (index: number) => {
      const itemIndex = index % stableItems.length;
      setActiveItem(stableItems[itemIndex]);
    };
        ...
        `}
          ...
          ${
            isMoving
              ...
              : 'bottom-[3.8em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2 cursor-pointer'
          }
        `}
          >
