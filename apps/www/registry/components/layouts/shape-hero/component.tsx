        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h1 className="mb-6 font-bold text-4xl tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <br />
              <span className="bg-gradient-to-r from-indigo-300 via-black/90 to-rose-300 bg-clip-text text-transparent italic dark:from-indigo-300 dark:via-white/90 dark:to-rose-300">
                {title2}
              </span>
            </h1>
          </motion.div>
