/**
 * @module PixelHeadingWord
 *
 * A whole-word pixel-font heading that swaps or cycles fonts on hover.
 *
...
export interface PixelHeadingWordProps extends React.ComponentProps<"h1"> {
  /**
  ...
  return (
    ...
    >
      <Tag
        ...
        tabIndex={0}
        className={cn(
          "cursor-default select-none text-foreground transition-all duration-150",
      ...
      {showLabel && (
        <output
          data-slot="pixel-heading-word-label"
          aria-live="polite"
          className={cn(
