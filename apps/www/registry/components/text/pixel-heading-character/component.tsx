...
export interface PixelHeadingCharacterProps extends React.ComponentProps<"h1"> {
  /**
...
export function PixelHeadingCharacter({
  ...
  return (
    <div
      data-slot="pixel-heading-character"
    ...
    >
      <Tag
        ...
        tabIndex={0}
        className={cn(
          "cursor-default select-none text-foreground",
      ...
      {showLabel && (
        <output
          data-slot="pixel-heading-character-label"
          aria-live="polite"
          className={cn(
