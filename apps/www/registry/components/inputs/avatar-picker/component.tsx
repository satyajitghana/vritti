...
export default function AvatarPicker({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto w-full max-w-[400px] overflow-hidden border border-primary/10 bg-gradient-to-b from-background/80 to-background/40 backdrop-blur-sm rounded-lg",
        className
      )}
    >
          ...
          <div className="relative flex flex-col items-center">
            ...
            >
              <div className="relative h-full w-full overflow-hidden rounded-full border border-primary/20 bg-gradient-to-b from-background/80 to-background shadow-lg shadow-primary/5">
                ...
                >
                  <div className="scale-[2.8] transform">{selectedAvatar.svg}</div>
                </motion.div>
              </div>
          ...
          <div className="space-y-6">
            <div className="relative">
              <div className="relative">
                <input
                  className={cn(
                    "h-12 w-full pl-10 text-base rounded-md border bg-background px-3 py-2 text-sm transition-all duration-200",
                    isFocused && "ring-2 ring-primary/20",
                    showError && "ring-2 ring-red-500/50 focus-visible:ring-red-500"
                  )}
                  maxLength={20}
              ...
              <AnimatePresence>
                {showError && (
                  <motion.p
                    ...
                    className="absolute mt-2 ml-1 text-red-500 text-xs"
                    exit={{ opacity: 0, y: -10 }}
            ...
            <button
              className="group relative h-12 w-full text-base inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground font-medium disabled:opacity-50 disabled:pointer-events-none"
              disabled={!isValid}
