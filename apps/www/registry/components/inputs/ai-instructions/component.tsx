...
/**
 * Individual instruction item with toggle state.
 */
export function InstructionsItem({
  ...
  return (
    ...
    >
      ...
      >
        {active && (
          <CheckSquare className="size-3" strokeWidth={2.5} />
        )}
      </div>
...
type DialogDescriptionProps = ComponentProps<typeof DialogDescription>
