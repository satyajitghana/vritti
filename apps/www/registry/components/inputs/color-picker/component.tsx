  ...
  return (
    <div className={cn("relative inline-block", className)}>
      <button
        ...
        className="flex w-[200px] items-center justify-start rounded-md border border-border bg-background px-3 py-2 text-left text-sm font-normal text-foreground hover:bg-accent"
        type="button"
      >
        <div
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute left-0 top-full z-50 mt-1 w-[240px] rounded-md border border-border bg-popover p-3 shadow-md"
            >
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <input
                    ...
                    className="h-8 flex-grow rounded-md border border-border bg-background px-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
