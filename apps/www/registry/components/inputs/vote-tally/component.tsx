...
function VoteTallyCount({ children, className, ...props }: VoteTallyCountProps) {
  ...
  return (
    <span className={cn(className)} data-slot="vote-tally-count" {...props}>
      {children ?? count}
    </span>
  )
}
...
function VoteTallyTitle({ children, className, ...props }: VoteTallyTitleProps) {
  return (
    <span className={cn(className)} data-slot="vote-tally-title" {...props}>
      {children}
    </span>
  )
}
...
function VoteTallyDescription({
  ...
  return (
    <span className={cn(className)} data-slot="vote-tally-description" {...props}>
      {children}
    </span>
  )
}
