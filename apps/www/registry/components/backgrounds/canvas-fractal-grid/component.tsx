...
const NoiseSVG = React.memo(() => (
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
    <filter id="canvas-fractal-grid-noise">
      <feTurbulence
        type="fractalNoise"
        baseFrequency="0.65"
        numOctaves="3"
    ...
    <rect width="100%" height="100%" filter="url(#canvas-fractal-grid-noise)" />
  </svg>
))
      ...
      >
        ...
        {enableGradient && (
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, transparent, hsl(var(--background)))",
