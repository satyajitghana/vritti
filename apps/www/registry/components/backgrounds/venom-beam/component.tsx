...
const VenomBeam: React.FC<VenomBeamProps> = ({ children, className = '' }) => {
  ...
  const particlesRef = useRef<VenomBeamParticle[]>([]);
  ...
  return (
    <div className={cn('relative h-96 w-full overflow-hidden bg-white dark:bg-black', className)}>
      <canvas
        ref={canvasRef}
