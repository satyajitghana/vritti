...
export interface ApplePlayButtonProps {
  className?: string;
  onToggle?: (isOpen: boolean) => void;
}

export default function ApplePlayButton({ className, onToggle }: ApplePlayButtonProps) {
  ...
  return (
    <div className={cn("flex items-center justify-center", className)}>
      <motion.div layout>
        <motion.div
          className="relative flex h-15 items-center justify-between overflow-hidden rounded-full"
            ...
            <div className="bg-foreground/20 flex h-full w-[60px] items-center justify-center gap-2 rounded-full">
              ...
              >
                <motion.svg
                  ...
                  className="text-foreground/80 h-5 w-5 fill-current"
                >
